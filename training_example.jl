...
set_nonzeros_trainable!(full_adder)
set_nonzeros_trainable!(xor)
set_nonzeros_trainable!(and)
set_nonzeros_trainable!(or)

# TODO: build weights view (might have implemented this already)
# yeah, parameters_view from afmdiffeq.jl
# might need to re-implement though